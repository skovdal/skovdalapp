...
?>
	...
	<form action="/systemNotifications/edit/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<input name="systemNotifications_id" type="hidden" value="<?php echo encodeId(purify($systemNotifications_id)); ?>">
		<div>
		...
		<div class="tagTab">
			...
			<input class="addTag" onclick="modal(0, 'basic', '/systemNotifications/edit/tags/add/modal.php', 'POST', '&refererModalId=<?php echo purify($modalId); ?>&systemNotifications_id=<?php echo encodeId(purify($systemNotifications_id)); ?>', true, 1);" type="button" value="Tilføj mærke" autofocus>
		...
		<div class="buttons">
			<input class="close" onclick="document.querySelectorAll('#modal-<?php echo purify($modalId); ?> div.close')[0].click();" type="button" value="Luk"><input type="submit" value="Gem systemnotifikation">
		</div>
	</form>
	<?php
