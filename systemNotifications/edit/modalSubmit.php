...
if($validateFlag == 200){
	...
	foreach($_POST as $postTitle => $postValue){
		if(substr($postTitle, 0, 9) == 'tag-name-'){
			$tagId = str_replace('tag-name-', '', $postTitle);
	...
	<script>
		...
		parent.toastr('success', 'Editer systemnotifikation', 'Systemnotifikationen blev editeret.', 0, true, '');
	</script>
	<?php
