...
if($validateFlag == 200){
?>
	<h1>Tilføj mærke på systemnotifikation</h1>
	<form action="/systemNotifications/tagsSingle/add/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<div>
			Tilføj nedenstående mærke på systemnotifikationen <strong><?php echo purify($systemNotifications_title); ?></strong>.<br>
			<br>
