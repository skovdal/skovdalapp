...
if($validateFlag == 200){
?>
	<h1>Eksporter markerede systemnotifikationer</h1>
	<ul>
	...
	<form action="/systemNotifications/exportMultiple/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<input name="systemNotifications_id" type="hidden" value="<?php echo purify($systemNotifications_id); ?>">
		<div>
			Eksporter <?php echo substr_count(purify($systemNotifications_id),',') +1; ?> <?php if(substr_count(purify($systemNotifications_id),',') == 0){echo 'systemnotifikation';}else{echo 'systemnotifikationer';} ?>.<br>
			<br>
			<input id="inputName" name="name" pattern=".{3,}" placeholder="systemnotifikationer" type="text" value="systemnotifikationer" required autofocus><label for="inputName">Filnavn</label><br>
		...
		<div>
			<div style="column-count:3;">
				...
				<div class="checkbox checked" onclick="modalCheckbox(this);"><input id="inputDataTitle" name="dataTitle" type="checkbox" value="1" checked><label for="inputDataTitle">Navn</label></div><br>
				<div class="checkbox checked" onclick="modalCheckbox(this);"><input id="inputDataMsg" name="dataMsg" type="checkbox" value="1" checked><label for="inputDataMsg">Supplerende navneoplysninger</label></div><br>
				<div class="checkbox checked" onclick="modalCheckbox(this);"><input id="inputDataUsers_id" name="dataUsers_id" type="checkbox" value="1" checked><label for="inputDataUsers_id">CVR-nummer</label></div><br>
				<div class="checkbox checked" onclick="modalCheckbox(this);"><input id="inputDataDate" name="dataDate" type="checkbox" value="1" checked><label for="inputDataDate">CPR-nummer</label></div><br>
				...
				<div class="checkbox checked" onclick="modalCheckbox(this);"><input id="inputDataIpAddress" name="dataIpAddress" type="checkbox" value="1" checked><label for="inputDataIpAddress">Postnummer</label></div><br>
