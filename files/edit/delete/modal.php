...
?>
	<h1>Slet fil</h1>
	<form action="/files/edit/delete/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<div>
			Bekræft venligst at du ønsker at slette filen <strong><?php echo purify($files_name); ?></strong>.<br>
			<?php
		...
		<div class="buttons">
			...
			<input class="delete" type="submit" value="Slet fil" <?php if($configuration_deleteConfirmationFiles == 9){echo 'disabled';}?>>
		</div>
	</form>
	<?php
