...
?>
	...
	<form action="/files/edit/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<div class="buttons">
			<input class="delete" onclick="modal(0, 'basic', '/files/edit/delete/modal.php', 'POST', '&refererModalId=<?php echo purify($modalId); ?>&files_id=<?php echo encodeId(purify($files_id)); ?>', true, 1);" type="button" value="Slet fil"><input class="close" onclick="document.querySelectorAll('#modal-<?php echo purify($modalId); ?> div.close')[0].click();" type="button" value="Luk"><input type="submit" value="Gem fil">
		</div>
	</form>
	<?php
