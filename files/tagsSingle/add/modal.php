...
if($validateFlag == 200){
?>
	<h1>Tilføj mærke på fil</h1>
	<form action="/files/tagsSingle/add/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<div>
			Tilføj nedenstående mærke på filen <strong><?php echo purify($files_name); ?></strong>.<br>
			<br>
