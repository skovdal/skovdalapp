...
if($validateFlag == 200){
?>
	<h1>Tilføj mærke på behandlingsaktivitet</h1>
	<form action="/processingActivities/tagsSingle/add/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<div>
			Tilføj nedenstående mærke på behandlingsaktiviteten <strong><?php echo purify($processingActivities_name); ?></strong>.<br>
			<br>
