...
?>
	...
	<form action="/processingActivities/edit/delete/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<div class="buttons">
			...
			<input class="delete" type="submit" value="Slet behandlingsaktivitet" <?php if($configuration_deleteConfirmationProcessingActivities == 9){echo 'disabled';}?>>
		</div>
	</form>
	<?php
