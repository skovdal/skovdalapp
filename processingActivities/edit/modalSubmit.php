...
if($validateFlag == 200){
	...
	");
	$stmt->bind_param('ssii', $name, $securityClearance, $identities_id, $processingActivities_id);
	$stmt->execute();
	...
	<script>
		...
		parent.toastr('success', 'Editer behandlingsaktivitet', 'Behandlingsaktivitetern blev editeret.', 0, true, '');
	</script>
	<?php
