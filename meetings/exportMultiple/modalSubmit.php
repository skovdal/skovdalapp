...
if(isset($_POST['identities_id']) === false){
	...
	$identities_id_array = explode(',', $identities_id);
}
...
if($validateFlag == 200){
	...
	$stmt->prepare("
		...
		FROM
			`c0`.`identities`
		WHERE
			`c0`.`identities`.`id` IN (" . implode(',', array_map('intval', $identities_id_array)) . ")
			AND
	...
	if(mysqli_num_rows($result) == 0){
		...
		while($row = mysqli_fetch_assoc($result)){
			if($fileFormat == 'CSV'){
				...
				if($dataType == 1){
					$content = $content . $textQualifier . $row['identities_type'] . $textQualifier . ',';
				}
				
				if($dataName == 1){
					$content = $content . $textQualifier . $row['identities_name'] . $textQualifier . ',';
				}
				
				if($dataName2 == 1){
					$content = $content . $textQualifier . $row['identities_name2'] . $textQualifier . ',';
				}
				
				if($dataCvrNumber == 1){
					$content = $content . $textQualifier . $row['identities_cvrNumber'] . $textQualifier . ',';
				}
				
				if($dataCprNumber == 1){
					$content = $content . $textQualifier . $row['identities_cprNumber'] . $textQualifier . ',';
				}
				
				if($dataAddress == 1){
					$content = $content . $textQualifier . $row['identities_address'] . $textQualifier . ',';
				}
				
				if($dataAddress2 == 1){
					$content = $content . $textQualifier . $row['identities_address2'] . $textQualifier . ',';
				}
				
				if($dataZipCode == 1){
					$content = $content . $textQualifier . $row['identities_zipCode'] . $textQualifier . ',';
				}
				
				if($dataCity == 1){
					$content = $content . $textQualifier . $row['identities_city'] . $textQualifier . ',';
				}
				
				if($dataCountry == 1){
					$content = $content . $textQualifier . $row['identities_country'] . $textQualifier . ',';
				}
				
				if($dataPhone == 1){
					$content = $content . $textQualifier . $row['identities_phone'] . $textQualifier . ',';
				}
				
				if($dataPhone2 == 1){
					$content = $content . $textQualifier . $row['identities_phone2'] . $textQualifier . ',';
				}
				
				if($dataEmail == 1){
					$content = $content . $textQualifier . $row['identities_email'] . $textQualifier . ',';
				}
				
				if($dataEmail2 == 1){
					$content = $content . $textQualifier . $row['identities_email2'] . $textQualifier . ',';
				}
				...
				if($dataType == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_type'] . $textQualifier . '</td>';
				}
				
				if($dataName == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_name'] . $textQualifier . '</td>';
				}
				
				if($dataName2 == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_name2'] . $textQualifier . '</td>';
				}
				
				if($dataCvrNumber == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_cvrNumber'] . $textQualifier . '</td>';
				}
				
				if($dataCprNumber == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_cprNumber'] . $textQualifier . '</td>';
				}
				
				if($dataAddress == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_address'] . $textQualifier . '</td>';
				}
				
				if($dataAddress2 == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_address2'] . $textQualifier . '</td>';
				}
				
				if($dataZipCode == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_zipCode'] . $textQualifier . '</td>';
				}
				
				if($dataCity == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_city'] . $textQualifier . '</td>';
				}
				
				if($dataCountry == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_country'] . $textQualifier . '</td>';
				}
				
				if($dataPhone == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_phone'] . $textQualifier . '</td>';
				}
				
				if($dataPhone2 == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_phone2'] . $textQualifier . '</td>';
				}
				
				if($dataEmail == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_email'] . $textQualifier . '</td>';
				}
				
				if($dataEmail2 == 1){
					$content = $content . '<td>' . $textQualifier . $row['identities_email2'] . $textQualifier . '</td>';
				}
				...
				if($dataType == 1){
					$content = $content . '"Type":"' . $row['identities_type'] . '",';
				}
				
				if($dataName == 1){
					$content = $content . '"Navn":"' . $row['identities_name'] . '",';
				}
				
				if($dataName2 == 1){
					$content = $content . '"Supplerende navn":"' . $row['identities_name2'] . '",';
				}
				
				if($dataCvrNumber == 1){
					$content = $content . '"CVR-nummer":"' . $row['identities_cvrNumber'] . '",';
				}
				
				if($dataCprNumber == 1){
					$content = $content . '"CPR-nummer":"' . $row['identities_cprNumber'] . '",';
				}
				
				if($dataAddress == 1){
					$content = $content . '"Adresse":"' . $row['identities_address'] . '",';
				}
				
				if($dataAddress2 == 1){
					$content = $content . '"Supplerende adresse":"' . $row['identities_address2'] . '",';
				}
				
				if($dataZipCode == 1){
					$content = $content . '"Postnummer":"' . $row['identities_zipCode'] . '",';
				}
				
				if($dataCity == 1){
					$content = $content . '"By":"' . $row['identities_city'] . '",';
				}
				
				if($dataCountry == 1){
					$content = $content . '"Land":"' . $row['identities_country'] . '",';
				}
				
				if($dataPhone == 1){
					$content = $content . '"Telefon":"' . $row['identities_phone'] . '",';
				}
				
				if($dataPhone2 == 1){
					$content = $content . '"Sekundær telefon":"' . $row['identities_phone2'] . '",';
				}
				
				if($dataEmail == 1){
					$content = $content . '"E-mail":"' . $row['identities_email'] . '",';
				}
				
				if($dataEmail2 == 1){
					$content = $content . '"Sekundær e-mail":"' . $row['identities_email2'] . '",';
				}
				...
				if($dataType == 1){
					$content = $content . $textQualifier . $row['identities_type'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataName == 1){
					$content = $content . $textQualifier . $row['identities_name'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataName2 == 1){
					$content = $content . $textQualifier . $row['identities_name2'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataCvrNumber == 1){
					$content = $content . $textQualifier . $row['identities_cvrNumber'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataCprNumber == 1){
					$content = $content . $textQualifier . $row['identities_cprNumber'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataAddress == 1){
					$content = $content . $textQualifier . $row['identities_address'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataAddress2 == 1){
					$content = $content . $textQualifier . $row['identities_address2'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataZipCode == 1){
					$content = $content . $textQualifier . $row['identities_zipCode'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataCity == 1){
					$content = $content . $textQualifier . $row['identities_city'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataCountry == 1){
					$content = $content . $textQualifier . $row['identities_country'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataPhone == 1){
					$content = $content . $textQualifier . $row['identities_phone'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataPhone2 == 1){
					$content = $content . $textQualifier . $row['identities_phone2'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataEmail == 1){
					$content = $content . $textQualifier . $row['identities_email'] . $textQualifier . $fieldDelimiter;
				}
				
				if($dataEmail2 == 1){
					$content = $content . $textQualifier . $row['identities_email2'] . $textQualifier . $fieldDelimiter;
				}
				...
				if($dataType == 1){
					$content = $content . '<Type>' . $row['identities_type'] . '</Type>';
				}
				
				if($dataName == 1){
					$content = $content . '<Navn>' . $row['identities_name'] . '</Navn>';
				}
				
				if($dataName2 == 1){
					$content = $content . '<Supplerende navn>' . $row['identities_name2'] . '</Supplerende navn>';
				}
				
				if($dataCvrNumber == 1){
					$content = $content . '<CVR-nummer>' . $row['identities_cvrNumber'] . '</CVR-nummer>';
				}
				
				if($dataCprNumber == 1){
					$content = $content . '<CPR-nummer>' . $row['identities_cprNumber'] . '</CPR-nummer>';
				}
				
				if($dataAddress == 1){
					$content = $content . '<Adresse>' . $row['identities_address'] . '</Adresse>';
				}
				
				if($dataAddress2 == 1){
					$content = $content . '<Supplerende adresse>' . $row['identities_address2'] . '/Supplerende adresse>';
				}
				
				if($dataZipCode == 1){
					$content = $content . '<Postnummer>' . $row['identities_zipCode'] . '</Postnummer>';
				}
				
				if($dataCity == 1){
					$content = $content . '<By>' . $row['identities_city'] . '</By>';
				}
				
				if($dataCountry == 1){
					$content = $content . '<Land>' . $row['identities_country'] . '</Land>';
				}
				
				if($dataPhone == 1){
					$content = $content . '<Telefon>' . $row['identities_phone'] . '</Telefon>';
				}
				
				if($dataPhone2 == 1){
					$content = $content . '<Sekundær telefon>' . $row['identities_phone2'] . '</Sekundær telefon>';
				}
				
				if($dataEmail == 1){
					$content = $content . '<E-mail>' . $row['identities_email'] . '</E-mail>';
				}
				
				if($dataEmail2 == 1){
					$content = $content . '<Sekundær e-mail>' . $row['identities_email2'] . '</Sekundær e-mail>';
				}
	...
	$tempName = tempnam($tempDir, 'identities');
