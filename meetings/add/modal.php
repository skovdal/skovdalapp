	...
	<form action="/identities/add/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<div>
			...
			<select class="photo" id="inputType" name="type" autofocus required>
				<option value="Fysisk person">Fysisk person</option>
				<option value="Juridisk person">Juridisk person</option>
				<option value="Offentlig myndighed">Offentlig myndighed</option>
			...
			<input id="inputCvrNumber"  name="cvrNumber" pattern="[0-9]{8}" placeholder="12345678" type="text"><label for="inputCvrNumber">CVR-nummer</label><br>
