...
if($validateFlag == 200){
?>
	<h1>Tilføj mærke på systemhændelse</h1>
	<form action="/systemEvents/tagsSingle/add/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<div>
			Tilføj nedenstående mærke på systemhændelseen <strong><?php echo purify($systemEvents_title); ?></strong>.<br>
			<br>
