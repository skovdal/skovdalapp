...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'www.chronus.cloud');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'www.chronus.cloud');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'www.chronus.cloud');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "Chronus\nwww.chronus.cloud");
}
