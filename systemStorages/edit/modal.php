...
<!-- 					<option value="WebDav" <?php if($systemStorages_type == 'WebDav'){echo 'selected';}?>>WebDav</option> -->
		...
		<div>
			...
			<div class="checkbox unchecked" onclick="modalCheckbox(this);" onchange="eval(document.querySelectorAll('#modal-<?php echo $modalId; ?> .modalScript')[0].value);"><input id="inputFTPPassiveMode" name="ftpPassiveMode" type="checkbox" value="1" <?php if($systemStorages_ftp_ssl_connect_port == 1){echo 'checked';}?>><label for="inputFTPPassiveMode">Passiv</label></div><br>
		</div>
