...
?>
	...
	<form action="/systemStorages/edit/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<div>
			<input id="inputUsername" name="username" onchange="checkConnection(0, document.querySelectorAll('#modal-' + modalId + ' form div.pulseContainer')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLHost')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLUsername')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLPassword')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLDbName')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLPort')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLSocket')[0]);" pattern=".{3,}" placeholder="pocahontas" type="text" value="<?php echo purify($systemStorages_username); ?>" required autofocus><label for="inputUsername">Brugernavn</label><br>
			<input id="inputPassword" name="password" onchange="checkConnection(0, document.querySelectorAll('#modal-' + modalId + ' form div.pulseContainer')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLHost')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLUsername')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLPassword')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLDbName')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLPort')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLSocket')[0]);" pattern=".{3,}" placeholder="Adgangskode" type="password" value="<?php echo purify($systemStorages_password); ?>" required><label for="inputPassword">Adgangskode</label><br>
		</div>
		
		<div>
			Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.<br>
			<br>
			<input id="inputHost" name="host" pattern=".{3,}" onchange="checkConnection(0, document.querySelectorAll('#modal-' + modalId + ' form div.pulseContainer')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLHost')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLUsername')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLPassword')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLDbName')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLPort')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLSocket')[0]);" placeholder="123.123.123.123" type="text" value="<?php echo purify($systemStorages_host); ?>" required><label for="inputHost">MySQL-værtsadresse</label><br>
			<input id="inputPort" name="port" pattern=".{3,}" onchange="checkConnection(0, document.querySelectorAll('#modal-' + modalId + ' form div.pulseContainer')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLHost')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLUsername')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLPassword')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLDbName')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLPort')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLSocket')[0]);" placeholder="123" type="text" value="<?php echo purify($systemStorages_port); ?>" required><label for="inputPort">MySQL-port</label><br>
			<input id="inputMySqlSocket" name="mySqlSocket" onchange="checkConnection(0, document.querySelectorAll('#modal-' + modalId + ' form div.pulseContainer')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLHost')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLUsername')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLPassword')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLDbName')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLPort')[0], document.querySelectorAll('#modal-' + modalId + ' form #inputMySQLSocket')[0]);" pattern=".{3,}" placeholder="/" type="text" value="<?php echo purify($systemStorages_mysql_socket); ?>" required><label for="inputMySqlSocket">MySQL-socket</label><br>
