...
?>
	...
	<form action="/systemStorages/edit/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<div>
			...
			<br>
			<input id="inputName" name="name" onchange="checkConnection(0, document.querySelectorAll('#modal-<?php echo $modalId; ?> form div.pulseContainer')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLHost')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLUsername')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPassword')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLDbName')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPort')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLSocket')[0]);" pattern=".{3,}" placeholder="Jens Nielsen" type="text" value="<?php echo purify($systemStorages_name); ?>" required autofocus><label for="inputName">Navn</label><br>
			<select id="inputType" name="type" onchange="checkConnection(0, document.querySelectorAll('#modal-<?php echo $modalId; ?> form div.pulseContainer')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLHost')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLUsername')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPassword')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLDbName')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPort')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLSocket')[0]);" required>
...
<!-- 					<option value="WebDav" <?php if($systemStorages_type == 'WebDav'){echo 'selected';}?>>WebDav</option> -->
			...
			<input id="inputStorageSize" name="storageSize" onchange="checkConnection(0, document.querySelectorAll('#modal-<?php echo $modalId; ?> form div.pulseContainer')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLHost')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLUsername')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPassword')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLDbName')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPort')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLSocket')[0]);" pattern=".{3,}" placeholder="1000000" type="text" value="<?php echo purify(storageSize($systemStorages_storageSize, 0)); ?>" required><label for="inputStorageSize">Lagerstørrelse</label><br>
		</div>
		
		<div>
			<input id="inputMySQLUsername" name="mysqlUsername" onchange="checkConnection(0, document.querySelectorAll('#modal-<?php echo $modalId; ?> form div.pulseContainer')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLHost')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLUsername')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPassword')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLDbName')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPort')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLSocket')[0]);" pattern=".{3,}" placeholder="pocahontas" type="text" value="<?php echo purify($systemStorages_mysql_username); ?>" required autofocus><label for="inputMySQLUsername">MySQL-brugernavn</label><br>
			<input id="inputMySQLPassword" name="mysqlPassword" onchange="checkConnection(0, document.querySelectorAll('#modal-<?php echo $modalId; ?> form div.pulseContainer')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLHost')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLUsername')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPassword')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLDbName')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPort')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLSocket')[0]);" pattern=".{3,}" placeholder="Adgangskode" type="password" value="<?php echo purify($systemStorages_mysql_password); ?>" required><label for="inputMySQLPassword">MySQL-adgangskode</label><br>
		</div>
		
		<div>
			Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.<br>
			<br>
			<input id="inputMySQLDbName" name="mysqlDbName" onchange="checkConnection(0, document.querySelectorAll('#modal-<?php echo $modalId; ?> form div.pulseContainer')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLHost')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLUsername')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPassword')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLDbName')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPort')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLSocket')[0]);" pattern=".{3,}" placeholder="Abcd" type="text" value="<?php echo purify($systemStorages_mysql_dbname); ?>" required><label for="inputMySQLDbName">MySQL-database</label><br>
			<input id="inputMySQLHost" name="mysqlHost" onchange="checkConnection(0, document.querySelectorAll('#modal-<?php echo $modalId; ?> form div.pulseContainer')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLHost')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLUsername')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPassword')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLDbName')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPort')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLSocket')[0]);" pattern=".{3,}" placeholder="mysql.skovdal.com eller 123.123.123.123" type="text" value="<?php echo purify($systemStorages_mysql_host); ?>" required><label for="inputMySQLHost">MySQL-værtsadresse</label><br>
			<input id="inputMySQLPort" name="mysqlPort" onchange="checkConnection(0, document.querySelectorAll('#modal-<?php echo $modalId; ?> form div.pulseContainer')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLHost')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLUsername')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPassword')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLDbName')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPort')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLSocket')[0]);" pattern=".{3,}" placeholder="3306" type="text" value="<?php echo purify($systemStorages_mysql_port); ?>"><label for="inputMySQLPort">MySQL-port</label><br>
			<input id="inputMySQLSocket" name="mysqlSocket" onchange="checkConnection(0, document.querySelectorAll('#modal-<?php echo $modalId; ?> form div.pulseContainer')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLHost')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLUsername')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPassword')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLDbName')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLPort')[0], document.querySelectorAll('#modal-<?php echo $modalId; ?> form #inputMySQLSocket')[0]);" pattern=".{3,}" placeholder="/var/run/mysqld/mysqld.sock" type="text" value="<?php echo purify($systemStorages_mysql_socket); ?>"><label for="inputMySQLSocket">MySQL-socket</label><br>
			<input id="inputTimeout" name="timeout" onchange="" pattern=".{3,}" placeholder="10s" type="text" value="<?php echo purify($systemStorages_ftp_connect_timeout); ?>" required><label for="inputTimeout">Timeout</label><br>
			<input id="inputFtpRemotePath" name="ftpRemotePath" onchange="" pattern=".{3,}" placeholder="/" type="text" value="<?php echo purify($systemStorages_ftp_put_remote_path); ?>" required><label for="inputFtpRemotePath">FTP remote path</label><br>
