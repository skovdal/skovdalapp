...
?>
	...
	<form action="/systemUsers/edit/delete/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<div>
			Bekræft venligst at du ønsker at slette systemlageret <strong><?php echo purify($systemUsers_name); ?></strong>.<br>
			<?php
		...
		<div class="buttons">
			...
			<input class="delete" type="submit" value="Slet systemlager" <?php if($configuration_deleteConfirmationSystemStorages == 9){echo 'disabled';}?>>
		</div>
	</form>
	<?php
