...
?>
	...
	<form action="/systemUsers/tagsMultiple/add/modalSubmit.php" enctype="application/x-www-form-urlencoded" method="post" onsubmit="submitForm(this);" target="<?php echo md5($_SERVER['SCRIPT_FILENAME']) . purify($modalId); ?>">
		...
		<div>
			Tilføj nedenstående mærke på <?php echo substr_count(purify($systemUsers_id),',') +1; ?> <?php if(substr_count(purify($systemUsers_id),',') == 0){echo 'systembruger';}else{echo 'systembrugere';} ?>.<br>
			<br>
