						...
						?>
							<tr>
								<td class="photo" onclick="
									...
									?>
										document.querySelectorAll('#modal-<?php echo purify($refererModalId); ?> form > div > div.photo')[0].style.backgroundImage = 'url(\'<?php echo '/serve/photo.php?id=' . encodeId($row['identities_photo_filesMetaData_id']); ?>\')';
									<?php
									}
									?>
									...
									?>
										<div class="photo" style="background-image:url('<?php echo '/serve/photo.php?id=' . encodeId($row['identities_photo_filesMetaData_id']); ?>');"></div>
									<?php
									}
